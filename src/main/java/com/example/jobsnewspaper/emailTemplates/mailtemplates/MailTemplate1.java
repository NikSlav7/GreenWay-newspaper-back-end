...
public class MailTemplate1 extends Template {
    ...
    public String getTemplateContent() {
        return " <div style=\"width: 600px; background-color: gainsboro;\">\n" +
                ...
                "\n" +
                "            <p style=\"width: 100%; text-align: center; font-size: 40px; font-weight: 600; font-family:'montserrat';\">Articles for 20 january</p>\n" +
                "\n" +
                "            <p style=\"width: 100%; text-align: center; font-family: 'montserrat'; font-size: 18px;\">These are the articles for today</p>\n" +
                "\n" +
